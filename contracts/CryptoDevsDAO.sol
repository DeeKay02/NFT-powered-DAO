...
contract CryptoDevsDAO is Ownable {
    ...
    // Create a payable constructor which initializes the contract instances for FakeNFTMarketplace and CryptoDevsNFT. The payable allows this constructor to accept an ETH deposit when it is being deployed
